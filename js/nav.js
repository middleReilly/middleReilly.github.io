...
function buildFooter() {
  ...
  footer.innerHTML = `
    <div class="footer-socials">
      <a href="https://github.com/middleReilly" target="_blank" rel="noopener"
         aria-label="GitHub" class="social-icon">
      ...
      <a href="https://www.linkedin.com/in/reilly-white-83b800356" target="_blank" rel="noopener"
         aria-label="LinkedIn" class="social-icon">
        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
